...
###########################################################################
# NOTES
# - "StarChaser" (No.1) with repaint to "RedShift" (No.2)
...
def AltPlot_JN(fout,title,data,symb,L3His,lb,ub,misc):
    ...
    if L3His:
        ...
        plt.text(6200,10000,r"(My L3, reference)",fontsize=16,family=family,\
            color='darkmagenta',fontweight='bold')
        plt.text(1800,17000,r"Intimidator 4",fontsize=18,family=family,\
    ...
    if misc:
        ...
        # Curve Fit
        # slope, intercept, r_value, p_value, std_err
        [m,b,r,p,std]=sp.stats.linregress(xdat3,ydat3)
        print 'slope ',m
        print 'intercept ',b
        print 'r squared ',r
        xfit3=np.linspace(7000,11000)
        yfit3=np.multiply(xfit3,m)+b
        plt.plot(xfit3,yfit3,'k-',color='darkgreen',linewidth=3.4,\
            label=r'_nolegend_',\
            path_effects=[outline])
        plt.plot(xfit,yfit,'k-',color='orangered',linewidth=3.4,\
            label=r'_nolegend_',\
        ...
        # Extra Labels
        plt.text(9000,16000,r"My MD",fontsize=16,family=family,\
            color='darkgreen',fontweight='bold')
        plt.text(7800,14000,r"Intimidator 4",fontsize=16,family=family,\
            color='darkgreen',fontweight='bold')
