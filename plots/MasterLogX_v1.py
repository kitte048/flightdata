...
###########################################################################
# Altitude Plot (J-N Range, up to 18000 Ns)
###########################################################################
def AltPlot_ALL(fout,title):
    ...
    dx = (xmax-xmin)/(nx-1.0)
    mx = 4
    xticks = [r"0",r"1,000",r"2,000",r"3,000",r"4,000",r"5,000",r"6,000",\
        r"7,000",r"8,000",r"9,000",r"10,000",r"11,000",r"12,000"]
    ...
    plt.text(0.4*(640.01+1100.0),500,r'J',fontsize=14,family=family,\
    ...
    plt.text(0.45*(1280.01+2200.0),500,r'K',fontsize=14,family=family,\
        color='k',fontweight='bold')
    ...
    plt.text(0.5*(2560.01+5000),500,r'L',fontsize=14,family=family,\
        color='k',fontweight='bold')
    ...
    plt.text(0.5*(5120.01+9440),500,r'M',fontsize=14,family=family,\
        color='k',fontweight='bold')

    # N-Range
    itot=np.linspace(10240.01,20480.0)
    ylow=itot-1.e6
    yhig=itot+1.e6
    plt.fill_between(itot,yhig,ylow,interpolate=True,alpha=0.5,\
        color='orangered',label='_nolegend_')
    plt.text(0.5*(10240.01+12000),500,r'N',fontsize=14,family=family,\
        color='k',fontweight='bold')
